...
function DepartmentTickets({ data }) {
  return (
    <div>
      ...
      DepartmentTickets
      <p>
        bucket count Live update and render in Table update ticket automatick
        using webscoket
      </p>
      <br />
      Table half - t from name- lead(focus) - copy btn - Title Genrate time -
      remeing Time in minitus & seconds & on click on ticket open in half part
      of desktop in that option to reply and if need any thing or solve Parller
      update into table and goes to solved bucket and update count || ticket in
      half
      <br />
